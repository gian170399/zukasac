...
<head>
    ...
    <title>G & M-Muebles para departamento</title>
</head>
...
<body>
        ...
        <nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-dark scrolling-navbar"  style="background-color: #0a2e36;">
            <div class="container">
                ...
                id="navegacion">
                    ...
                    <a href="../admin/login.php" class="btn btn btn-success ml-lg-5"><i class="fa fa-sign-in" aria-hidden="true"></i> Iniciar Sesion</a>
                </div>
            </div>
    ...
    <div class="contenido" style="background: url('../img/fondo_horario.png'), #fff;">
        <main class="container">
            ...
            <!-- <div class="row">
                <ol class="breadcrumb content :before">
                    <li><a href="../index.php">Inicio</a></li>
                    <li class="active">Muebles para departamento</li>
                </ol>
            </div> -->
            <div class="row">
                <div class="col">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Muebles para departamento</li>
                        </ol>
                    </nav>
            ...
            <div class="row py-4 ">
                <?php foreach($resultado_depa as $foto): ?>
                    <div class="col-12 col-sm-6 col-lg-3 mb-4" >
                        <div class="card carta" style="background: url('../img/fondo.png'), #fff;">
                                <div class="inner">
                                    <a href="../archivos/single.php?id=<?php echo $foto['id']; ?>">
                                        <img class="card-img-top w-100 img-fluid" src="../fotos/<?php echo $foto['imagen'] ?>" alt="Card image cap">
                                    </a>
                                </div>
                                <div class="card-body">
